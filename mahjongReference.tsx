...
export const SPECIAL_HANDS_LIST = [
  // 16台
  '天胡', '地胡', '人胡', '大四喜', '八仙過海', '十六不搭', '字一色',
  // 8台
  '天聽', '地聽', 'Migi', '七搶一', '大三元', '小四喜', '五暗刻', '嚦咕嚦咕', '清一色',
  // 5台
  '四暗刻',
  // 4台
  '小三元', '混一色', '碰碰胡',
  ...
  '三暗刻', '平胡',
  // 1台
  '門清', '不求', '三元牌', '卡窿/邊張', '搶槓', '槓上', '海底撈月', '河底撈魚', '正花/正風', '花槓', '連莊',
];

export const MAHJONG_REFERENCE = [
  // 24台
  { name: '天胡', fan: '24台', desc: '莊家開牌即胡' },
  // 16台
  { name: '地胡', fan: '16台', desc: '閒家摸第一張牌自摸' },
  { name: '人胡', fan: '16台', desc: '閒家第一巡胡牌' },
  { name: '大四喜', fan: '16台', desc: '由東、南、西、北四組刻子(或槓子)組成' },
  { name: '十六不搭', fan: '16台', desc: '東南西北中發白,147/258/369不同花色' },
  { name: '字一色', fan: '16台', desc: '全由字牌組成' },
  // 8台
  { name: '天聽', fan: '8台', desc: '莊家打出第一張牌後，立即宣告聽牌' },
  { name: '地聽', fan: '8台', desc: '打出第一張牌後，立即宣告聽牌' },
  { name: 'Migi', fan: '8台', desc: '海底8張內宣告聽牌' },
  { name: '八仙過海', fan: '8台', desc: '持有8張花牌' },
  ...
  { name: '不求', fan: '1台', desc: '門清並且自摸 (also called 自摸)' },
  { name: '三元牌', fan: '1台', desc: '持有中、發、白其中刻子' },
  { name: '卡窿/邊張', fan: '1台', desc: '胡順子中間或邊邊的牌 (e.g. 3 for 2-4, 7 for 8-9)' },
